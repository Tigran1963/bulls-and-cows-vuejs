         ...
         <div class="settings__body">
            <div class="settings__length">
               ...
               <div class="settings__length-field">
                  <input
                     type="radio"
                     id="settings-code-length-four"
                     :checked="store.codeLength === 4"
               ...
               <div class="settings__length-field">
                  <input
                     type="radio"
                     id="settings-code-length-five"
                     :checked="store.codeLength === 5"
            ...
            <div class="settings__attempts">
               ...
               <input
                  ...
                  max="10"
                  placeholder="5-10"
                  id="settings-attempts-number"
                  :value="store.maxAttempts"
                  @input="handleMaxAttemptsInput"
               />
            </div>
